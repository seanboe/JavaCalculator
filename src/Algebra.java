public class Algebra {
  ...
  public static double bisectionZeros(Function
      function, double lowerLimit, double upperLimit) throws InvalidInputsException, ArithmeticException, OperatorOnlyException {
  ...
  public static double computeZeros(Function
      function, double point) throws InvalidInputsException, ArithmeticException, OperatorOnlyException, VariableDefinitionException {
