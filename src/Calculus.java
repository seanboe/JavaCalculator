...
public class Calculus {
     ...
     */
    public static double computeDefiniteIntegral(Function
        function, double lowBound, double highBound) throws ArithmeticException, OperatorOnlyException {
     ...
     * @throws ArithmeticException
     */
    public static double computeDerivativeAtAPoint(Function
        function, double inputValue) throws ArithmeticException, OperatorOnlyException, VariableDefinitionException {
     ...
     * @throws ArithmeticException
     */
    public static double computeSum(Function
        function, int lowerBound, int upperBound) throws ArithmeticException, OperatorOnlyException {
     ...
     * @throws ArithmeticException
     */
    public static double computeEndBehavior(Function
        function, boolean positiveInfinity) throws VariableDefinitionException, ArithmeticException, OperatorOnlyException {
